...
export default function SignatureFooter() {
    return (
        <>
            <p className="text-md font-medium text-gray-800 mr-0">
                Made by
                <span className="font-bold text-lg pl-1 text-teal-700">
                    Faisal Alqarni
                </span>
                .
            </p>
            ...
            <div className="grid grid-flow-col gap-3">
                ...
                >
                    <svg
                        ...
                        height="24"
                        viewBox="0 0 24 24"
                        className="fill-gray-800 hover:fill-teal-800 transition-all duration-300"
                    >
                        <path d="M 2.3671875 3 L 9.4628906 13.140625 L 2.7402344 21 L 5.3808594 21 L 10.644531 14.830078 L 14.960938 21 L 21.871094 21 L 14.449219 10.375 L 20.740234 3 L 18.140625 3 L 13.271484 8.6875 L 9.2988281 3 L 2.3671875 3 z M 6.2070312 5 L 8.2558594 5 L 18.033203 19 L 16.001953 19 L 6.2070312 5 z"></path>
                    </svg>
                </a>
                <a
                    href="https://github.com/FRYM-S"
                    target="_blank"
                ...
                <a
                    href="https://www.linkedin.com/in/faisal-alqarni-318631304?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                    target="_blank"
